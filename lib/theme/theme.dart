...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      onPrimaryContainer: Color(0xff5b396d),
      secondary: Color(0xff32628d),
      onSecondary: Color(0xffffffff),
      secondaryContainer: Color(0xffd0e4ff),
      onSecondaryContainer: Color(0xff144a74),
      ...
      secondaryFixedDim: Color(0xff9dcafc),
      onSecondaryFixedVariant: Color(0xff144a74),
      tertiaryFixed: Color(0xffffdad9),
      onTertiaryFixed: Color(0xff331112),
      tertiaryFixedDim: Color(0xfff4b7b7),
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      secondary: Color(0xff00395f),
      onSecondary: Color(0xffffffff),
      secondaryContainer: Color(0xff42709d),
      ...
      secondaryFixed: Color(0xff42709d),
      onSecondaryFixed: Color(0xffffffff),
      secondaryFixedDim: Color(0xff275883),
  ...
  static ColorScheme lightHighContrastScheme() {
    return const ColorScheme(
      ...
      onPrimaryContainer: Color(0xffffffff),
      secondary: Color(0xff002e4f),
      onSecondary: Color(0xffffffff),
      secondaryContainer: Color(0xff184c76),
      onSecondaryContainer: Color(0xffffffff),
      ...
      onPrimaryFixedVariant: Color(0xffffffff),
      secondaryFixed: Color(0xff184c76),
      onSecondaryFixed: Color(0xffffffff),
      secondaryFixedDim: Color(0xff003559),
      onSecondaryFixedVariant: Color(0xffffffff),
  ...
  static ColorScheme darkScheme() {
    return const ColorScheme(
      ...
      secondary: Color(0xff9dcafc),
      onSecondary: Color(0xff003355),
      secondaryContainer: Color(0xff144a74),
  ...
  static ColorScheme darkMediumContrastScheme() {
    return const ColorScheme(
      ...
      secondary: Color(0xffc4dfff),
      onSecondary: Color(0xff002744),
      secondaryContainer: Color(0xff6794c3),
      ...
      primaryFixed: Color(0xfff5d9ff),
      onPrimaryFixed: Color(0xff200033),
      primaryFixedDim: Color(0xffe1b7f5),
      onPrimaryFixedVariant: Color(0xff49285b),
      secondaryFixed: Color(0xffd0e4ff),
      onSecondaryFixed: Color(0xff001224),
      secondaryFixedDim: Color(0xff9dcafc),
      onSecondaryFixedVariant: Color(0xff00395f),
      tertiaryFixed: Color(0xffffdad9),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      secondaryContainer: Color(0xff9ac7f8),
      ...
      primaryFixedDim: Color(0xffe1b7f5),
      onPrimaryFixedVariant: Color(0xff200033),
      secondaryFixed: Color(0xffd0e4ff),
